...
const achievements = [
  {
    icon: Trophy,
    title: "Guinness World Records title for most participants in an online generative AI hackathon — Cognizant (USA), 14 January 2026.",
    badge: "Global Winner",
  ...
  },
  {
    ...
    title: "HackerRank",
    badge: "Runner up",
    description: "Runner up in a HackerRank competition for presenting an AI-driven esports ecosystem Gamerise",
...
export function Achievements() {
  ...
  return (
    <section id="achievements" ref={sectionRef} className="relative py-24 sm:py-32 md:py-40 min-h-screen flex items-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
            ...
            <div className="relative group">
              ...
              <div className="relative rounded-2xl overflow-hidden border-2 border-[#2a2bf7]/30 shadow-2xl shadow-[#2a2bf7]/20 group-hover:border-[#00b7ff]/50 transition-all duration-300 group-hover:scale-[1.01]">
                <img
                  ...
                  alt="Guinness World Records title for most participants in an online generative AI hackathon — Cognizant (USA), 14 January 2026. - Team Gravity Not Found"
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                  <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-gradient-to-r from-[#2a2bf7]/90 to-[#8b49ff]/90 border border-[#00b7ff]/50 backdrop-blur-sm mb-3">
                    <div className="w-3 h-3 rounded-full bg-[#3fb950] ring-2 ring-[#3fb950]/60 shadow-[0_0_18px_rgba(63,185,80,0.9)] animate-slow-pulse" aria-hidden />
                  </div>
                  <h3 className="text-3xl sm:text-4xl font-heading font-bold text-white mb-2">HackerRank </h3>
                  <p className="text-white/90 text-sm sm:text-base">For 6 Badges</p>
                </div>
              </div>
            </div>
          </div>

          {/* HackerRank Image - Featured */}
              ...
              <div className="relative rounded-2xl overflow-hidden border-2 border-[#00b7ff]/30 shadow-2xl shadow-[#00b7ff]/20 group-hover:border-[#8b49ff]/50 transition-all duration-300 group-hover:scale-[1.01]">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8">
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-[#00b7ff]/90 to-[#2a2bf7]/90 border border-[#8b49ff]/50 backdrop-blur-sm mb-3">
                    ...
                    <span className="text-sm sm:text-base font-medium text-white">CERTIFICATE</span>
                  </div>
                  <h3 className="text-2xl sm:text-3xl font-heading font-bold text-white mb-2">Google Developer Groups</h3>
                  <p className="text-white/90 text-sm sm:text-base">First place in national competition for innovative AI Developer</p>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Guinness World Records Certificate (add image at public/guinness-certificate.jpg) */}
        <div className={`transition-all duration-700 delay-300 flex justify-center ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
          <div className="relative group mb-8 max-w-md w-full">
            <div className="absolute inset-0 bg-gradient-to-r from-[#2a2bf7] via-[#8b49ff] to-[#00b7ff] rounded-2xl blur-2xl opacity-20 transition-opacity duration-300" />
            <div className="relative rounded-2xl overflow-hidden border-2 border-[#8b49ff]/20">
              <div className="w-full aspect-[3/4] sm:aspect-[3/4] bg-gray-50">
                <img
                  src="/guinness-certificate.jpg"
                  alt="Guinness World Records certificate"
                  className="w-full h-full object-cover object-center"
                />
              </div>
              <div className="p-6 sm:p-8 bg-transparent">
                <h3 className="text-2xl sm:text-3xl font-heading font-bold mb-2 text-foreground">Guinness World Records</h3>
                <p className="text-sm sm:text-base text-foreground/75">Participant in the Guinness World Records title for most participants in an online generative AI hackathon — Cognizant (USA), 14 January 2026.</p>
              </div>
            </div>
          </div>
        </div>
