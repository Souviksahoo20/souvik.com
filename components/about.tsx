...
export function About() {
  ...
  constructor() {
    this.name = "SOUVIK SAHOO";
    this.role = "AI Developer & Frontend Developer ";
    this.location = "India";
    ...
    >
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16 items-start mb-16">
          {/* Code Block */}
          <div className={`transition-all duration-700 delay-200 w-full lg:w-5/12 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 -translate-x-12"}`}>
            <div className="bg-[#0d1117] border border-[#30363d] rounded-lg shadow-2xl overflow-hidden">
              ...
              <div className="p-6">
                <pre className="text-sm sm:text-base font-mono text-[#c9d1d9] overflow-x-auto max-h-64 sm:max-h-80">
          ...
          {/* Text Content */}
          <div className={`space-y-6 text-base sm:text-lg leading-relaxed transition-all duration-700 delay-300 w-full lg:w-7/12 ${isVisible ? "opacity-100 translate-x-0" : "opacity-0 translate-x-12"}`}>
            <div className="space-y-4">
              <p className={`text-[#c9d1d9] transition-all duration-700 delay-400 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
                ...
                <span className="text-[#7ee787] font-semibold transition-all duration-500 delay-600">Frontend Developer</span>, passionate about building
