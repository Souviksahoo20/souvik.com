...
import { Sparkles, Zap, Cpu, Database, Code2, Terminal, GraduationCap } from "lucide-react"
...
const skillCategories = [
  ...
  },
  {
    ...
    title: "Education",
    color: "text-[#a5a5ff]",
    skills: ["BTech CSE - Sister Nivedita University (2022-2026, CGPA: 8.76)", "Smart India Hackathon (Top Team)", "Oscillation Hackathon (Finalist)", "Research: Driver Fatigue Detection, Smart Irrigation"],
  },
]
...
export function Skills() {
  ...
  return (
    <section id="skills" ref={sectionRef} className="relative py-24 sm:py-32 md:py-40 min-h-screen flex items-center">
